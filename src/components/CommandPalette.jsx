...
import { VscSymbolColor, VscTerminal, VscFiles, VscGoToFile, VscGear, VscColorMode, VscHome, VscAccount, VscCode, VscEdit, VscMail, VscGithubAlt } from 'react-icons/vsc';
import { MdNavigateNext } from 'react-icons/md';

import { THEMES } from '@/lib/themes';
import styles from '@/styles/CommandPalette.module.css';

const CommandPalette = ({ isOpen, onClose, onToggleTerminal, isTerminalOpen }) => {
  ...
  const getCommands = useCallback(() => {
    const baseCommands = [
      ...
      },
      {
        ...
        action: () => window.open('https://github.com/NandanNayak-dev', '_blank'),
      },
      {
        id: 'go-settings',
    ...
    return baseCommands;
  }, [navigate, onToggleTerminal, isTerminalOpen]);
